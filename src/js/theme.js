...
function initTheme() {
	...
	// Применяем сохранённую тему или системные настройки пользователя
	...
	btn.addEventListener('click', () => {
		...
		updateToggleIcon(btn, isLight);
	});
}

const SVG_SUN = `<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const SVG_MOON = `<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function updateToggleIcon(btn, isLight) {
	...
	// Светлая тема активна → показываем луну (вернуться в тёмную)
	// Тёмная тема активна → показываем солнце (перейти в светлую)
